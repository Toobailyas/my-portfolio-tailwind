...
<section className="lg:h-96 mb-8 sm:h-60 md:h-70">
  <div className="grid grid-cols-1 sm:grid-cols-12 mt-8 ml-9 mr-9">
    ...
    <div className="col-span-7 place-self-center text-center sm:text-left">
      ...
      <p className="text-[#ccc8f3fb] text-base sm:text-lg mb-6 lg:text-xl">
        A passionate Frontend Developer with expertise in HTML, CSS,
        TypeScript, and Next.js. A programming enthusiast and FAST’29
        BS AI student with a keen interest in AI and building intelligent,
    ...
    <div className="col-span-5 place-self-center mt-4 lg:mt-0">
      <div className="rounded-full bg-[#4f4852d8] w-[250px] h-[250px] relative lg:w-[400px] lg:h-[400px]">
        <Image
